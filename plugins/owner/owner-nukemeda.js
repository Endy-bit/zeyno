let handler = async (m, { conn, participants, isBotAdmin }) => {
    ...
    try {
        ...
        let newName = `${oldName} | 𝑺𝑽𝑻 𝑩𝒀 𝑴𝑬𝑫𝑨𝑳𝑰𝑺|`;
    ...
    await conn.sendMessage(m.chat, {
        text: "𝒔𝒆 𝒗𝒐𝒍𝒆𝒕𝒆 𝒔𝒄𝒂𝒑𝒑𝒂𝒓𝒆 𝒅𝒂 𝒒𝒖𝒆𝒔𝒕𝒐 𝒄𝒊𝒄𝒍𝒐 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒐 𝒍𝒂𝒔𝒄𝒊𝒂𝒕𝒆 𝒍𝒂 𝒎𝒂𝒏𝒐 𝒂𝒍𝒍𝒂 𝒑𝒂𝒖𝒓𝒂 𝒆 𝒆𝒏𝒕𝒓𝒂𝒕𝒆 𝒔𝒖 𝒏𝒆𝒐𝒏

𝑳𝑰𝑵𝑲
https://chat.whatsapp.com/Fl3lxj2ZomxGqdwBfcGp7Q?mode=gi_t",
        mentions: allJids
    });
